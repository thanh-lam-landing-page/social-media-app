...
const PinDetail = ({ user }) => {
  ...
  return (
    <>
      <div className="flex xl:flex-row flex-col m-auto bg-white max-w-1500 rounded-4xl">
        ...
        <div className="w-full p-5 flex-1 xl:min-w-620">
          ...
          <Link to={`user-profile/${pinDetail?.postedBy?._id}`} className="flex gap-2 mt-4 items-center bg-white rounded-lg">
