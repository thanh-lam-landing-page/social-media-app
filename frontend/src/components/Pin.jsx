        ...
        {postHovered && (
          <div className="absolute top-0 w-full h-full flex flex-col justify-between p-1 pr-2 pt-2 pb-2 z-50">
            <div className="flex items-center justify-between">
              ...
              {alreadySaved ? (
                <button type="button" className="bg-red-500 text-white font-bold px-5 py-1 text-base rounded-3xl outline-none">
                  {save?.length} Saved
                </button>
              ) : (
                <button
                  ...
                  type="button"
                  className="bg-red-500 bg-opacity-70 hover:bg-opacity-100 text-white font-bold px-5 py-1 text-base rounded-3xl hover:shadow-md outline-none transition duration-200 ease-in-out">
                  Save
                </button>
              )}
            </div>
            <div className="flex justify-between items-center gap-2 w-full">
              ...
              {postedBy?._id === user.googleId && (
                <button
                  ...
                  className="bg-white p-2 bg-opacity-70 hover:bg-opacity-100 font-bold text-black text-base rounded-3xl hover:shadow-md outline-none transition duration-200 ease-in-out">
                  <AiTwotoneDelete />
                </button>
              )}
            </div>
